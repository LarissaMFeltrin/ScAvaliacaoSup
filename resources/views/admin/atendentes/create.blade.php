...
<head>
    ...
    <title>Cadastrar Atendente - SCORDON</title>
    ...
    <section class="py-12">
        <div class="container mx-auto px-6 max-w-4xl">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 mb-6">Adicione um novo funcionário da SCORDON como atendente</p>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form method="POST" action="{{ route('admin.atendentes.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-medium text-blue-800">Sobre os Atendentes</h3>
                                <div class="mt-2 text-sm text-blue-700">
                                    <p>Atendentes são <strong>funcionários da SCORDON</strong> que podem atender chamados de qualquer empresa cliente. Eles não estão vinculados a uma empresa específica.</p>
                                </div>
                            </div>
                        </div>
                    </div>
